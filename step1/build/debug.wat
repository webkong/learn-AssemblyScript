(module
 ...
 (import "env" "alert" (func $assembly/index/alert (param i32)))
 (import "env" "notice" (func $assembly/index/notice (param i32)))
 ...
 (export "showAlert" (func $export:assembly/index/showAlert))
 (start $~start)
 ...
 (func $assembly/index/showAlert (param $str i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  ...
  i32.store $0
  local.get $1
  call $assembly/index/notice
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.add
  global.set $~lib/memory/__stack_pointer
 )
 (func $export:assembly/index/showAlert (param $0 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  global.set $~lib/memory/__stack_pointer
